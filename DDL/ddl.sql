create database pencoder

use pencoder

create table pencoder.app_user
(
...
create table pencoder.customer
(
...
INSERT INTO customer (id, name, email, phone, country, created_at) VALUES
